...
const Index = () => {
  ...
  const rooms = [
    ...
    },
    {
      ...
      features: ["Private Balcony", "Jacuzzi Access", "Air Conditioning", "Premium Amenities"]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="bg-gradient-hero text-white py-4 px-6 sticky top-0 z-50 backdrop-blur-sm">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            <a href="#rooms" className="hover:text-cream transition-colors">Rooms</a>
            <a href="#amenities" className="hover:text-cream transition-colors">Amenities</a>
            <a href="#location" className="hover:text-cream transition-colors">Location</a>
            <a href="#contact" className="hover:text-cream transition-colors">Contact</a>
          </nav>
          <Button variant="sunset" size="sm">Book Now</Button>
        </div>
      </header>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-6">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto">
            ...
            featuring air conditioning, private balconies, and peaceful garden views.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="tropical" size="xl" className="shadow-elegant">
              Explore Our Rooms
            </Button>
      ...
      <section id="rooms" className="py-20 px-6">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-primary mb-4">Our Comfortable Rooms</h3>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Choose from our carefully designed rooms, each offering modern amenities 
              and a peaceful atmosphere for your stay in Galle.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {rooms.map((room, index) => (
              <Card key={index} className="overflow-hidden shadow-warm hover:shadow-elegant transition-all duration-300 transform hover:-translate-y-2">
                ...
                <CardHeader>
                  ...
                  <CardDescription className="text-lg">
                    <span className="text-2xl font-bold text-tropical-teal">{room.price}</span>
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2 mb-6">
                    {room.features.map((feature, i) => (
                      <Badge key={i} variant="secondary" className="bg-accent/90 text-accent-foreground">{feature}</Badge>
                    ))}
                  </div>
      ...
      <section className="py-20 px-6 bg-soft-gray">
        <div className="container mx-auto">
          <h3 className="text-4xl font-bold text-center text-primary mb-16">Experience Shanvila</h3>
      ...
      <section id="amenities" className="py-20 px-6">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-primary mb-4">Premium Amenities</h3>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Enjoy our carefully selected amenities designed to make your stay comfortable and memorable.
            </p>
          </div>
      ...
      <section id="location" className="py-20 px-6 bg-soft-gray">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-4xl font-bold text-primary mb-8">Location & Information</h3>
              
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <MapPin className="text-tropical-teal mt-1 flex-shrink-0" size={20} />
                  <div>
                    <h4 className="font-semibold text-primary mb-2">Address</h4>
                    <p className="text-muted-foreground">
                      82/2B1 Ginthota Kalegana Road<br />
                      Piyadigama, Galle, Sri Lanka<br />
                ...
                <div className="flex items-start gap-4">
                  <Clock className="text-tropical-teal mt-1 flex-shrink-0" size={20} />
                  <div>
                    <h4 className="font-semibold text-primary mb-2">Check-in & Check-out</h4>
                    <p className="text-muted-foreground">
                      <strong>Check-in:</strong> 3:00 PM - 6:00 PM<br />
                ...
                <div className="flex items-start gap-4">
                  <Users className="text-tropical-teal mt-1 flex-shrink-0" size={20} />
                  <div>
                    <h4 className="font-semibold text-primary mb-2">Guest Policy</h4>
                    <p className="text-muted-foreground">
                      Children of all ages are welcome<br />
                      Cribs and extra beds are not available<br />
            ...
            <div>
              <div 
                ...
                style={{ backgroundImage: `url('/lovable-uploads/10acfb31-a454-4739-bdee-ec3104a06a4d.png')` }}
              />
              <div className="mt-8 text-center">
                <h4 className="text-xl font-semibold text-primary mb-4">Ready to Experience Shanvila?</h4>
